...
pygame.init()
pygame.display.init()
screen = pygame.display.set_mode((8,32)) # create a 50x50 px window
...
#	'''
    ...
    try:
        while 1:
            ...
            pygame_surface = pygame.image.fromstring(imgString, (32,8), 'RGB')
            screen.blit(pygame_surface, (32,8))
            pygame.display.flip()
            ## end of part
...
#	''' take current image data and display it on the LED strip '''
    ...
    pygame_surface = pygame.image.fromstring(imgString, (32,8), 'RGB')
    screen.blit(pygame_surface, (7,7))
    pygame.display.flip()
    strip.show()
...
while True:
    ...
    im = Image.new('RGB', (32, 8), color = (0,0,0))
    d = ImageDraw.Draw(im)
